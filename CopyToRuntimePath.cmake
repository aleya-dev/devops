...
function (copy_files_to_runtime_path)
    ...
    if (NOT UNIX)
        ...
        execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory "${FUNCTION_ARGS_DESTINATION}")
        foreach (FILENAME ${FUNCTION_ARGS_FILES})
            execute_process(COMMAND ${CMAKE_COMMAND} -E copy_if_different "${FILENAME}" "${FUNCTION_ARGS_DESTINATION}/")
        endforeach ()
    endif ()
endfunction ()
